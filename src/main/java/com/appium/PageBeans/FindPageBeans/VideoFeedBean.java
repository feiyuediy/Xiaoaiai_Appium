...
public class VideoFeedBean extends BaseBean{
    ...
    @Xpath(xpath={"//android.widget.TextView[@resource-id='com.zkj.guimi:id/avli_video_desc']"})
    @Description(description="")
    public  PlainText  textView2;


    @Xpath(xpath={"//android.widget.ImageView[@resource-id='com.zkj.guimi:id/avli_user_header']"})
    @Description(description="")
    public  View  imageView9;


    @Xpath(xpath={"//android.widget.TextView[@resource-id='com.zk.j.guimi:id/avli_user_name']"})
    ...
    @Xpath(xpath={"//android.widget.TextView[@resource-id='com.zkj.guimi:id/avli_ad_desc' and @text='#自媒体广告#']"})
    @Description(description="#自媒体广告#")
    ...
    @Xpath(xpath={"//android.widget.TextView[@resource-id='com.zkj.guimi:id/avli_ad_desc' and @text='#很长阿斯蒂芬阿斯蒂芬 阿斯蒂芬 按时 啥地方#']"})
    @Description(description="#很长阿斯蒂芬阿斯蒂芬 阿斯蒂芬 按时 啥地方#")
    public  PlainText  textView5;


    @Xpath(xpath={"//android.support.v7.widget.RecyclerView[@resource-id='com.zkj.guimi:id/scroll']/android.widget.RelativeLayout[5]/android.widget.ImageView[1]"})
    @Description(description="")
    ...
    @Xpath(xpath = {""})
    @Description(description = "")
    public View videoFeed;

    @Xpath(xpath = {""})
    @Description(description = "")
    public View videoHeadImg;

    @Xpath(xpath = {""})
    @Description(description = "")
    public View videoFeedName;



    public VideoFeedBean(AppiumDriver aDriver){super(aDriver);}
