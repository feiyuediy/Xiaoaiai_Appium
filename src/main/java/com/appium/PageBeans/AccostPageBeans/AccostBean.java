...
public class AccostBean extends BaseBean{
    ...
    @Xpath(xpath={"//android.widget.TextView[@resource-id='com.zkj.guimi:id/liip_name_tv' and @text='asd2']"})
    ...
    @Xpath(xpath={"//android.support.v7.widget.RecyclerView[@resource-id='com.zkj.guimi:id/scroll']/android.widget.RelativeLayout[2]/android.widget.RelativeLayout[1]/android.widget.ImageView[1]"})
    @Description(description="")
    ...
    @Xpath(xpath={"//android.widget.TextView[@text='心情']"})
    @Description(description="心情")
    public  PlainText  mood;


    @Xpath(xpath={"//android.widget.TextView[@text='榜单']"})
    ...
    public  PlainText  mineText;




    public AccostBean(AppiumDriver aDriver){super(aDriver);}
