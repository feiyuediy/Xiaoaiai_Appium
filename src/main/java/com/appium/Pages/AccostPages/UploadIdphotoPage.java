...
import com.appium.PageBeans.AccostPageBeans.UploadIdphotoBean;
...
public class UploadIdphotoPage {
    ...
    public UploadIdphotoPage(AppiumDriver appiumDriver){
    ...
    //判断更新浮层是否存在
    public boolean is(){
        return uploadIdphotoBean.camera.isExists();
    }
    ...
    public boolean isdelect(){
        return uploadIdphotoBean.tips.isExists();
    }
    //判断是否存在更新id照按钮
    public boolean isExitUpload(){
        return uploadIdphotoBean.upIdpthotoButoon.isExists();
    }
    //点击id照
