...
import com.appium.PageBeans.FindPageBeans.RecordVideoBean;
...
public class RecordVideoPage {
    ...
    public RecordVideoPage(AppiumDriver appiumDriver){
    ...
    public boolean isConcatExist(){
        if (recordVideoBean.concat.isExists()){
            return true;
        }else {
            return false;
        }
    ...
    public boolean isExitDialog(){
        if (recordVideoBean.dialog_ok.isExists()){
            return true;
        }else {
            return false;
        }
