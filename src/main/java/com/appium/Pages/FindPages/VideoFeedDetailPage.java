...
import com.appium.PageBeans.FindPageBeans.VideoFeedDetailBean;
...
public class VideoFeedDetailPage {
    ...
    public VideoFeedDetailPage(AppiumDriver appiumDriver){
    ...
    public void editComment(String com){
        videoFeedDetailBean.commontEdit.clear();
