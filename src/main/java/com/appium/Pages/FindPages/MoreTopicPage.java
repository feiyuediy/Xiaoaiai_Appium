...
import com.appium.PageBeans.FindPageBeans.MoreTopicBean;
...
public class MoreTopicPage {
    ...
    public MoreTopicPage(AppiumDriver appiumDriver){
    ...
    public boolean isBackExit(){
        return moreTopicBean.back.isExists();
    }
    ...
    public boolean isEditExit(){
        return moreTopicBean.editFeedButton.isExists();
    }
    ...
    public String getTopicDesc(int i){
        ...
        String desc = "描述";
        moreTopicBean.topicDiscription.setXpath(xpath);
    ...
    public String getTopicNum(int i){
        ...
        String desc = "数量";
        moreTopicBean.topicNum.setXpath(xpath);
    ...
    public boolean isExitState(){
        return moreTopicBean.state.isExists();
    }
